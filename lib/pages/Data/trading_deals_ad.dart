...
class TradingDealsAd extends StatefulWidget {
  static const String id = "\webPageAdvertisementList";
  const TradingDealsAd({super.key});

  @override
  _TradingDealsAdState createState() => _TradingDealsAdState();
}

class _TradingDealsAdState extends State<TradingDealsAd> {
  final DatabaseReference _dbRef = FirebaseDatabase.instance.ref('advertisements/trading_deald_ad');
