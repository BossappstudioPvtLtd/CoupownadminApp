...
class HelpAndSupport extends StatefulWidget {
  static const String id = "\webPageHelpAndSupport";
...
class _HelpAndSupportState extends State<HelpAndSupport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold( backgroundColor: appColorPrimary,
      appBar: AppBar(title: const Text('Add Help and Support'),backgroundColor: appColorPrimary, ),
       body: SingleChildScrollView(
        child: Padding( padding: const EdgeInsets.all(8.0),
         child: Column(children: [ const SizedBox(width: 40),
         Card(
              color: Colors.white,
              child: Column(
